...
class TestStockEntry(unittest.TestCase):
	...
	def test_warehouse_company_validation(self):
		...
		set_perpetual_inventory(0, company)
		frappe.get_doc("User", "test2@ektai.mail")\
	...
	def test_warehouse_user(self):
		add_user_permission("Warehouse", "_Test Warehouse 1 - _TC", "test@ektai.mail")
		add_user_permission("Warehouse", "_Test Warehouse 2 - _TC1", "test2@ektai.mail")
		add_user_permission("Company", "_Test Company 1", "test2@ektai.mail")
		...
		frappe.set_user("Administrator")
		remove_user_permission("Warehouse", "_Test Warehouse 1 - _TC", "test@ektai.mail")
		remove_user_permission("Warehouse", "_Test Warehouse 2 - _TC1", "test2@ektai.mail")
		remove_user_permission("Company", "_Test Company 1", "test2@ektai.mail")
