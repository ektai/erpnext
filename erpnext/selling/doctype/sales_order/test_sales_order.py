...
class TestSalesOrder(unittest.TestCase):
	...
	def test_warehouse_user(self):
		frappe.permissions.add_user_permission("Warehouse", "_Test Warehouse 1 - _TC", "test@ektai.mail")
		frappe.permissions.add_user_permission("Warehouse", "_Test Warehouse 2 - _TC1", "test2@ektai.mail")
		frappe.permissions.add_user_permission("Company", "_Test Company 1", "test2@ektai.mail")

		test_user = frappe.get_doc("User", "test@ektai.mail")
		test_user.add_roles("Sales User", "Stock User")
		test_user.remove_roles("Sales Manager")

		test_user_2 = frappe.get_doc("User", "test2@ektai.mail")
		test_user_2.add_roles("Sales User", "Stock User")
		test_user_2.remove_roles("Sales Manager")

		frappe.set_user("test@ektai.mail")
		...
		frappe.set_user("test2@ektai.mail")
		so.insert()

		frappe.set_user("Administrator")
		frappe.permissions.remove_user_permission("Warehouse", "_Test Warehouse 1 - _TC", "test@ektai.mail")
		frappe.permissions.remove_user_permission("Warehouse", "_Test Warehouse 2 - _TC1", "test2@ektai.mail")
		frappe.permissions.remove_user_permission("Company", "_Test Company 1", "test2@ektai.mail")
