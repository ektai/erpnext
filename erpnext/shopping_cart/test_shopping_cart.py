...
class TestShoppingCart(unittest.TestCase):
	...
	def test_get_cart_new_user(self):
		...
		self.assertEqual(quotation.contact_person,
			frappe.db.get_value("Contact", dict(email_id="test_cart_user@ektai.mail")))
	...
	def login_as_new_user(self):
		self.create_user_if_not_exists("test_cart_user@ektai.mail")
		frappe.set_user("test_cart_user@ektai.mail")

	def login_as_customer(self):
		self.create_user_if_not_exists("test_contact_customer@ektai.mail",
			"_Test Contact For _Test Customer")
		frappe.set_user("test_contact_customer@ektai.mail")
