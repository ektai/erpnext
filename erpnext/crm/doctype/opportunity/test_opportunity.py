...
class TestOpportunity(unittest.TestCase):
	...
	def test_make_new_lead_if_required(self):
		new_lead_email_id = "new{}@ektai.mail".format(random_string(5))
		args = {
			"doctype": "Opportunity",
		...
		# new lead should be created against the new.opportunity@ektai.mail
		...
		# create new customer and create new contact against 'new.opportunity@ektai.mail'
